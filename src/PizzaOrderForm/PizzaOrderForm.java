...
public class PizzaOrderForm extends JFrame {
    ...
    public void createToppingsPanel(){
        ...
        eyeballOlivesCB = new JCheckBox("Olives");
        tentacleCalamariCB = new JCheckBox("Onions");
        gummyWormsCB = new JCheckBox("Chicken");
        blackGarlicCB = new JCheckBox("Beef");
        bloodyMarinaraCB = new JCheckBox("Pepper");
        cobwebCheeseCB = new JCheckBox("Extra Cheese");
    ...
    public void createControlPanel(){
        ...
        orderBtn.addActionListener(e ->{
            ...
            if (eyeballOlivesCB.isSelected() == true){
                receiptArea.append("Olives" + "\t\t\t\t1.00\n" );
                totalCost +=1.00;
            }
            if (tentacleCalamariCB.isSelected() == true){
                receiptArea.append("Onions" + "\t\t\t1.00\n" );
                totalCost +=1.00;
            }
            if (gummyWormsCB.isSelected() == true){
                receiptArea.append("Peppers" + "\t\t\t\t1.00\n" );
                totalCost +=1.00;
            }
            if (blackGarlicCB.isSelected() == true){
                receiptArea.append("Chicken" + "\t\t\t\t1.00\n" );
                totalCost +=1.00;
            }
            if (bloodyMarinaraCB.isSelected() == true){
                receiptArea.append("Beef" + "\t\t\t\t1.00\n" );
                totalCost +=1.00;
            }
            if (cobwebCheeseCB.isSelected() == true){
                receiptArea.append("Extra Cheese" + "\t\t\t\t1.00\n" );
                totalCost +=1.00;
            }
